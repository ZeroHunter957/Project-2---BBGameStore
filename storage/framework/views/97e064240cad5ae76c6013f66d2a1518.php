    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <span class="breadcrumb"><a href="/menu">Home</a> > <a href="/shop">Shop</a> > Assasin Creed</span>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Netbeans\laravel\Project2\resources\views/game/details.blade.php ENDPATH**/ ?>